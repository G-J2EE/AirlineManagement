...
<br><br><br><br><br><br>
	...
	<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
    <label for="nationality">Passenger Nationality</label>
    <select class="form-control" id="nationality" name="PNat">
    ...
    <div class="form-check">
        <input class="form-check-input" type="radio" name="PGen" id="male" value="Male" checked>
        <label class="form-check-label" for="male">Male</label>
    </div>
    <div class="form-check">
        <input class="form-check-input" type="radio" name="PGen" id="female" value="Female">
        <label class="form-check-label" for="female">Female</label>
    </div>
</fieldset>

				<fieldset class="form-group">
					<label>Numero de passport</label> <input type="text" 
