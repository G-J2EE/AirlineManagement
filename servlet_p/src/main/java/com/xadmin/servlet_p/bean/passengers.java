...
public class passengers {
    ...
    public passengers(String PName, String PNat, String PGen, int PPass, String PAdd, int Pphone) {
    	 this.PName = PName;
         this.PNat = PNat;
         this.PGen = PGen;
         this.PPass = PPass;
    ...
    public passengers(int PI, String PName, String PNat, String PGen, int PPass, String PAdd, int Pphone) {
        this.PI = PI;
        this.PName = PName;
        this.PNat = PNat;
        this.PGen = PGen;
