    ...
    <div class="card">
        <div class="card-body">
            ...
            <fieldset class="form-group">
                ...
                <input type="text" value="<c:out value='${passenger.PName}' />" class="form-control" name="PName" required="required">
            </fieldset>

            <fieldset class="form-group">
                <label>Passenger Nationality</label> 
                <input type="text" value="<c:out value='${passenger.PNat}' />" class="form-control" name="PNat">
            </fieldset>

            <fieldset class="form-group">
                <label>Passenger Gender</label> 
                <input type="text" value="<c:out value='${passenger.PGen}' />" class="form-control" name="PGen">
            </fieldset>

            <fieldset class="form-group">
                <label>Passenger Number</label> 
                <input type="text" value="<c:out value='${passenger.PPass}' />" class="form-control" name="PPass">
            </fieldset>

            <fieldset class="form-group">
                <label>Passenger Address</label> 
                <input type="text" value="<c:out value='${passenger.PAdd}' />" class="form-control" name="PAdd">
            </fieldset>
